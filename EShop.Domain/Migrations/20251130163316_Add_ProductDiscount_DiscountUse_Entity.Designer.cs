...
namespace EShop.Domain.Migrations
{
    ...
    [Migration("20251130163316_Add_ProductDiscount_DiscountUse_Entity")]
    partial class Add_ProductDiscount_DiscountUse_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.Entities.Product.ProductDiscount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EShop.Domain.Entities.Product.ProductDiscountUse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EShop.Domain.Entities.Product.ProductDiscountUse", b =>
                {
                    b.HasOne("EShop.Domain.Entities.Product.ProductDiscount", "ProductDiscount")
                        .WithMany("ProductDiscountUse")
                        .HasForeignKey("ProductDiscountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EShop.Domain.Entities.Product.Product", null)
